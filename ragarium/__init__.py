...
1. VectorDatabaseBuilder
   ...
   典型用法：
       from ragarium import VectorDatabaseBuilder
...
3. RagRunner
   ...
   典型用法：
       from ragarium import VectorDatabaseBuilder, RagRunner
...
4. EvalEngine
   ...
   典型用法：
       from ragarium import EvalEngine
...
def __getattr__(name: str):
    ...
    if name == "EvalEngine":
        ...
        return EvalEngine
    raise AttributeError(f"module 'ragarium' has no attribute {name!r}")
